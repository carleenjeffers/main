...
public class XMLTokenizer
{
	...
	public static void main(String args[])
	{
		...
		// also restructured using Java idiom CheckDontCatch
		...
		Arrays.stream(args).forEach(filename -> {
			try {
				...
				System.out.println("Error tokenizing: " + e.getMessage());
				System.exit(0);
			}
		});
	}
	...
	private static void processFile(String filename) throws Exception {
		...
		// using CheckDontCatch idiom do a check that the file exists
		...
		do
		{
			// let this IOException bubble up to main
